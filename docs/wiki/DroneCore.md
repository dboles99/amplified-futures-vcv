...
| Module | Routing |
|---|---|
| [[DroneClone]] | DroneCore one octave below as sub-fundamental |
| [[Choke]] | Per-voice gain and muting |
| [[Drift]] | SMOOTH output → TIMBRE CV for slow harmonic wander |
| [[Harmonic-Pressure]] | V/OCT OUT → DroneCore V/OCT IN for microtonal partial stacks |

---

## See also

[[DroneClone]] · [[Drift]] · [[Harmonic-Pressure]] · [[Music-Theory]]
