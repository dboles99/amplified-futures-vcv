...
- **Fixed panning is intentional**: the spread is tuned for the Amplified Futures Branca-stack patching style. Use WallConductor WIDTH for dynamic stereo control.
